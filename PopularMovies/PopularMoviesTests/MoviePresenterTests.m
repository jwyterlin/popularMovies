...
it (@"should use the title available. ", ^{
    ...
    MovieModel *movieModel = [[MovieModel alloc] initWithTitle:title year:year overview:overview posterPath:posterPath];
...
it (@"should not use an unavailable title. ", ^{
    ...
    MovieModel *movieModel = [[MovieModel alloc] initWithTitle:nil year:year overview:overview posterPath:posterPath];
    MoviePresenter *moviePresenter = [[MoviePresenter alloc] initWithMovie:movieModel];
...
it (@"should not have overview. ", ^{
    ...
    MovieModel *movieModel = [[MovieModel alloc] initWithTitle:title year:year overview:nil posterPath:posterPath];
    MoviePresenter *moviePresenter = [[MoviePresenter alloc] initWithMovie:movieModel];
